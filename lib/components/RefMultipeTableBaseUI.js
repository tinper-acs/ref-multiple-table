...
var RefMultipleTableBase = function (_Component) {
  ...
  function RefMultipleTableBase(props) {
    ...
    _this2.getFieldid = function (str) {
      var _this2$props$modalPro = _this2.props.modalProps,
          modalProps = _this2$props$modalPro === undefined ? {} : _this2$props$modalPro;
    ...
    _this2.checkedArray = [];
    _this2.checkedMap = {};
    _this2.TableView = props.multiple ? multiSelect(_nextUi.Table, _nextUi.Checkbox) : _nextUi.Table;
    return _this2;
  } //每页数据数
  //表格数据
  ...
  */
  ...
  RefMultipleTableBase.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        chosenText = _props.chosenText,
        hiddenChosenText = _props.hiddenChosenText;
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        ...
        { closeButton: true, fieldid: this.getFieldid('header') },
        _react2["default"].createElement(
          _nextUi.Modal.Title,
      ...
      _react2["default"].createElement(
        ...
        { ref: function ref(_ref) {
          ...
          }, fieldid: this.getFieldid('body') },
        _react2["default"].createElement(_nextUi.Spin, { container: this.modalRef, show: showLoading }),
        ...
        _react2["default"].createElement(
          _RefCoreTab2["default"],
          {
            ...
            hiddenChosenText: hiddenChosenText
          },
        ...
        tableIsSelecting && _react2["default"].createElement(_nextUi.Pagination, _extends({
          first: true,
          last: true,
          prev: true,
          next: true,
      ...
      _react2["default"].createElement(
        ...
        { className: 'ref-core-modal-footer ', fieldid: this.getFieldid('footer') },

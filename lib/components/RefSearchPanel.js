...
var _searchPanelTinperNext = require('search-panel-tinper-next');

var _searchPanelTinperNext2 = _interopRequireDefault(_searchPanelTinperNext);
...
// const { FormItem } = Form;
var AdvancedContainer = _searchPanelTinperNext2["default"].AdvancedContainer;
/**
...
var RefSearchPanel = function (_Component) {
  ...
  RefSearchPanel.prototype.render = function render() {
    ...
    return _react2["default"].createElement(
      _searchPanelTinperNext2["default"],
      {
...
exports["default"] = _nextUi.Form.createForm()(RefSearchPanel);
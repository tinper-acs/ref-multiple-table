...
class Demo2 extends Component {
    ...
    launchTableHeader = () => {
        ...
        propsVal["columnsData"] = colunmsList;
    }
    render() {
        this.launchTableHeader();
        const { getFieldError, getFieldProps } = this.props.form;
        console.log('renderData',propsVal.tableData)
        return (
            <div>
                <RefWithInput
                    {...propsVal}
